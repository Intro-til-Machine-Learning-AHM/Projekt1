...
Some summary statistics have been summarized in the tables in Table \ref{tab:stats}. This should
...
%!!3.3!!
The linear correlations of the non-standardized data are show in Table \ref{tab:cor}.
...
\begin{figure}
  \centering{}
  \includegraphics[width=0.5\textwidth]{cum_var}
  \caption{TODO caption}\label{fig:cumvar}
\end{figure}

\begin{figure}
  \centering{}
  \includegraphics[width=0.5\textwidth]{exp_var_hist}
  \caption{TODO caption}\label{fig:exp_var_hist}
\end{figure}
...
\begin{figure}
  \centering{}
  \includegraphics[width=0.5\textwidth]{principal_directions}
  \caption{TODO caption}\label{fig:principal_directions}
\end{figure}

\begin{figure}
  \centering{}
  \includegraphics[width=0.5\textwidth]{principal_directions_n}
  \caption{TODO caption}\label{fig:principal_directions_n}
\end{figure}
...
\begin{figure}
  ...
  \caption{TODO caption}\label{fig:PCA}
\end{figure}

\begin{figure}
  \centering{}
  \includegraphics[width=0.5\textwidth]{PCA_n}
  \caption{TODO caption}\label{fig:PCA_n}
\end{figure}
