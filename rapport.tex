...
!!3.2!!
Histograms are shown in figure(TO DO?? "x.hist.png"). The attributes pregs, insulin, dia_pedig
...
(TODO ?? "exp_var_hist.png") for an overview of the explained variance for each principal component.
...
Figure (TODO ?? "principal_directions.png") shows in which direction the principal components point. The "spikes"
...
after standardization. This is visualized in figure (TODO ?? "principal_directions_n.png").
...
(TODO ?? "PCA.png") and standardized (TODO ?? "PCA_n.png")
...
>>>>>>> b35840def9a8e80fcc8d46c310ccd44abe8d7ee1
