...
All of the attributes have the same y-axes. This detail is important because each attribute describes a
biological factor, which vary greatly in value.
For attribute 1(pregs) there is not a high variance. This could be because of the Indian women not having
...
When the data is not standardized, the principal component
...
2D can more or less be thought of as projection of the data down to the plane
in the insulin and glucose directions. Figure (??) shows in which direction
the principal components point. The "spikes" in each graph show how the principal
directions point mostly in the direction of insulin and glucose, respectively.
After standardization, the principal directions align much less with any principal
components, which does make sense considering how the variance had to be presented
by more principal components after standardization. This is visualized in figure
(??).
...
to also have a high value in the other. This translates to an apparent tendency
for older women to have been pregnant more and for women who have been pregnant
more often to be older. (Eventually see figure(??))

!!3.4!!
The primary modelling aim, to predict whether an Indian woman had diabetes or not
...
and the occurrence of diabetes. After inspecting the boxplots above, it is
very likely that insulin will dominate.
